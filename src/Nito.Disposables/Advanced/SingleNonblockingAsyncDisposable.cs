...
namespace Nito.Disposables.Advanced
{
    ...
    /// </remarks>
    public sealed class SingleNonblockingAsyncDisposable<T> : IAsyncDisposable
    {
        /// <summary>
        ...
        public SingleNonblockingAsyncDisposable(T context, Func<T, ValueTask> disposeAsync)
        {
