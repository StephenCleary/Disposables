...
namespace Nito.Disposables.Internals
{
    ...
    /// </summary>
    public sealed class ReferenceCountedDisposable<T> : SingleDisposable<IReferenceCounter<object>>, IReferenceCountedDisposable<T>
        where T : class, IDisposable
    {
        ...
        /// </summary>
        public ReferenceCountedDisposable(IReferenceCounter<object> referenceCounter)
        ...
        /// <inheritdoc/>
        protected override void Dispose(IReferenceCounter<object> referenceCounter) => (referenceCounter.TryDecrementCount() as IDisposable)?.Dispose();
